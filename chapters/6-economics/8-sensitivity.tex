...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\textwidth]{chapters/6-economics/figures/Sensitivity_WACC.jpg}
  \captionof{figure}{Sensitivity of WACC on KPIs}
  \label{Sensitivity_WACC}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\textwidth]{chapters/6-economics/figures/Sensitivity_CAPEX.jpg}
