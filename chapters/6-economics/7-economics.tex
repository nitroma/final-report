...
\subsection{Key assumptions}
 ...
 \begin{table}[h]
   ...
   \textbf{4}                   & The price of products sold by Nitroma escalates by a factor of 2.8\% every year based on the annual change in the Consumer Price Index of China \cite{ceic_data_china_2021}.   \\
...
NPV is the value of all future cash flows over the lifetime of a project discounted to the present value. NPV is commonly used as an indicator of the profitability of a business and gives the present value of total profits. Equation \ref{eqn:npv} displays the calculation of NPV \cite{kenton_net_2021}:
