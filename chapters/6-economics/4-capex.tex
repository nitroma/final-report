...
Land                  & \begin{tabular}[c]{@{}l@{}}Industial land price is \$24.33/m\textbackslash{}superscript\{2\} in Nanjing. \\ Plant size is 0.12km\textbackslash{}superscript\{2\}.\end{tabular}                                                                           & 2,920,000 \\
Design \& Engineering & \begin{tabular}[c]{@{}l@{}}Cost spent designing and constructing the plant, typically paid to contractor. \\ This is approximately 25\% of the sum of ISBL and OSBL.\end{tabular}                                                                        & 3,094,170 \\
...
One-off chemicals     & \begin{tabular}[c]{@{}l@{}}The plant has installed a refrigeration cycle to lower the \\ operating temperature of one of the crystallizers. Given \\ that the refrigerant does not need to be replaced, \\ it is categorized as CAPEX.\end{tabular}      & 9,315     \\
Working Captial       & \begin{tabular}[c]{@{}l@{}}Funds to purchase raw materials and utitlies \\ for start-up prior to earning profit.\end{tabular}                                                                                                                            & 2,944,278 \\\bottomrule
\end{tabular}
\end{table}