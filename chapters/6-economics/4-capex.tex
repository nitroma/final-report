...
The inside battery limits (ISBL) investment is the cost of purchasing and installing all equipment. Lang has proposed  ISBL is calculated using various installation factors from Towler\cite{sinnott_chemical_2020}: 
\begin{equation}
