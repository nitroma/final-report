...
The inside battery limits (ISBL) investment is the cost of purchasing and installing all equipment. ISBL is calculated using various installation factors from Towler\cite{: 
\begin{equation}
