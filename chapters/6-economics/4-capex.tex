...
\end{wrapfigure}
Total investment of Nitroma was calculated to be \$22.6 million, by adding ISBL and additional costs listed in Table \ref{tab:CAPEXadditional}. It should be noted that due to the small volumetric flowrate in the plant leading to pilot-scale separation units. Equipment cost of these might be inacc 