...
Land                                                             & \begin{tabular}[c]{@{}l@{}}Industial land price is \$24.33/m\textbackslash{}textsuperscript\{2\} in Nanjing. \\ Plant size is 0.12km\textsuperscript{2}.\end{tabular}                                                                   & 2,920,000 \\\hline
...
Contingency                                                      & \begin{tabular}[c]{@{}l@{}}Extra costs added into the project to allow flucation of the\\ cost estimate since the number of equipments is uncertain \\ until the of construction phase. Approximated to 10\% \\ of the sum of ISBL and OSBL\end{tabular} & 1,237,668 \\\hline
\begin{tabular}[c]{@{}l@{}}One-off \\ chemicals\end{tabular}     & \begin{tabular}[c]{@{}l@{}}The plant has installed a refrigeration cycle to lower the \\ operating temperature of one of the crystallizers. Given \\ that the refrigerant does not need to be replaced, \\ it is categorized as CAPEX.\end{tabular}      & 9,315     \\\hline
