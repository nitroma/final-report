...
\begin{tabular}{lll}
\toprule
Item                                                             & Description                                                                                                                                                                                                                                              & USD       \\\midrule
OSBL                                                             & \begin{tabular}[c]{@{}l@{}}Outside Battery Limits, this is cost that is addition to the \\ equipment cost and accounts for site infrastructure. OSBL \\ is estimated to be 40\% of ISBL.\end{tabular}                                                    & 3,536,195 \\\hline
Land                                                             & \begin{tabular}[c]{@{}l@{}}Industial land price is \$24.33/m\textbackslash{}textsuperscript\{2\} in Nanjing. \\ Plant size is 0.12km\textbackslash{}textsuperscript\{2\}.\end{tabular}                                                                   & 2,920,000 \\\hline
\begin{tabular}[c]{@{}l@{}}Design \& \\ Engineering\end{tabular} & \begin{tabular}[c]{@{}l@{}}Cost spent designing and constructing the plant, typically paid to \\ contractor. This is approximately 25\% of the sum of ISBL and OSBL.\end{tabular}                                                                        & 3,094,170 \\\hline
Contingency                                                      & \begin{tabular}[c]{@{}l@{}}Extra costs added into the project to allow flucation of the\\ cost estimate since the number of equipments is uncertain \\ until the of construction phase. Approximated to 10\% \\ of the sum of ISBL and OSBL\end{tabular} & 1,237,668 \\
\begin{tabular}[c]{@{}l@{}}One-off \\ chemicals\end{tabular}     & \begin{tabular}[c]{@{}l@{}}The plant has installed a refrigeration cycle to lower the \\ operating temperature of one of the crystallizers. Given \\ that the refrigerant does not need to be replaced, \\ it is categorized as CAPEX.\end{tabular}      & 9,315     \\
\begin{tabular}[c]{@{}l@{}}Working \\ Captial\end{tabular}       & \begin{tabular}[c]{@{}l@{}}Funds to purchase raw materials and utitlies for start-up prior to \\ earning profit.\end{tabular}                                                                                                                            & 2,944,278\\\bottomrule
\end{tabular}
\end{table}