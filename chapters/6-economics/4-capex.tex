...
\begin{equation}
    ISBL=\sigma C_{e}*\left(\left(1+f_{p}\right)\frac{f_{er}++f_{el}f_{i}+f_{c}+f_{s}+f_{l}}{f_{m}}\right)
\end{equation}
Values of each installation factor can be found in Appendix. Using this method, the overall installtion factor is calculated to be 3.68 and ISBL is \$8.84 million.
