...
\end{wrapfigure}
Total investment of Nitroma was calculated to be \$22.6 million, by adding ISBL and additional costs listed in Table \ref{tab:CAPEXadditional}. It should be noted that due Nitroma is operating a small plant, separation units, particularly packed columns are smaller to common industrial-installed units. This contributed to the low investment figure.