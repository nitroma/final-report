...
OSBL                                                             & \begin{tabular}[c]{@{}l@{}}Outside Battery Limits, this is cost that is addition to the \\ equipment cost and accounts for site infrastructure. OSBL \\ is estimated to be 40\% of ISBL.\end{tabular}                                                    & 3,536,195 \\
...
\begin{tabular}[c]{@{}l@{}}Working \\ Captial\end{tabular}       & \begin{tabular}[c]{@{}l@{}}Funds to purchase raw materials and utitlies for start-up prior to \\ earning profit.\end{tabular}                                                                                                                            & 2,944,278
\end{tabular}
\end{table}