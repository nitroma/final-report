...
\Cref{tab:equipment purchase} summarized all major units purchased by Nitroma. Due to the variety of equipment types, detail breakdown of individual equipment cost is not discussed here but can be found in XX.
...
\end{wrapfigure}
Total investment of Nitroma was calculated to be \$22.6 million, by adding ISBL and additional costs listed in Table \ref{tab:CAPEXadditional}. It should be noted that due to the small volumetric flowrate in the plant, separation units, particularly packed columns are smaller to common industrial-installed units. This contributed to the low investment figure.