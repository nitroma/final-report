...
The total OPEX of the project was calculated to be \$18.2 million per annum based on current prices. A categorical breakdown of the OPEX can be seen in Figure XX. Furthermore, Nitroma's cost of production was found to be \$15.81 per kg of output generated (detailed in Section XX), which is lesser than the speciality chemical industry average of \$24.54 per kg (XX).