...
Table XX displays the annual cost of raw materials incurred by Nitroma. The unit costs of raw materials in Year 1 are obtained from the negotiated price agreement with DEdwards Corp plc found in Section XX. For future costs, a cost escalation factor of 2.6\% is applied to account for the annual increase in prices based upon inflation in China (XX). This is reflected on Nitroma’s financial statements in Section XX.
