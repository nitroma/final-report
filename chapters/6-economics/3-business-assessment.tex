...
\label{sec:expansion}
As discussed in \cref{sec:product-capacity}, Nitroma will commence operations at 275 days per year in 2023. Given the maximum number of operating days available in a year are 340, this reflects an \SI{81}{\percent} initiating capacity. Every 5 years up to 2043, Nitroma will increase its capacity by an additional 10 days per year in line with the CAGRs of the P-ABA, P-ABH and O-TOL markets that are detailed in \cref{sec:market-analysis}.  This decision is motivated by Nitroma’s desire to retain a stable market share during its 20-year lifetime. \Cref{tab:Expansion} summarises the projected results from Nitroma’s plant expansion.
...
\begin{table}[h]
    ...
    \begin{tabularx}{\linewidth}{l|X|X}
        & \textit{Helpful} & \textit{Harmful} \\ \midrule
        ...
        \begin{itemize}[topsep=0em,leftmargin=1em]
            \item An inherently safe design protects Nitroma from strict safety legislation in China
            \item An innovative continuous process gives Nitroma a low CAPEX and OPEX
            \item A 12.5\% price cut allows Nitroma to quickly acquire market share
            \item A diverse product portfolio will allow Nitroma to withstand market fluctuations
        \end{itemize}\end{minipage} & \begin{minipage}[t]{\linewidth} \makebox[\linewidth]{\color{yellow}\textbf{Weaknesses}}
        \begin{itemize}[topsep=0em,leftmargin=1em]
            \item There is local bias against buying from foreign-invested businesses
            \item \55\% debt financing leads to large interest payments
            \item Zeolite-based catalysis of nitration is unproven at an industrial level
        ...
        \begin{itemize}[topsep=0em,leftmargin=1em]
            \item Nitroma could enhance its operating capacity to 340 days/year in an attempt generate more revenue
            \item Nitroma could explore sales in international markets
        \end{itemize}\end{minipage} & \begin{minipage}[t]{\linewidth} \makebox[\linewidth]{\color{red}\textbf{Threats}}
        \begin{itemize}[topsep=0em,leftmargin=1em]
            \item Weak IP laws threaten the uniqueness of Nitroma’s nitration process as competitors may replicate it
            \item A stalling economy and diminishing population growth in China threatens product demand
...
\begin{table}[H]
\centering
\caption{PESTEL analysis on Nitroma's business, scored by severity (S) and likelihood (L)}
\label{tab:pestel}
\resizebox{\textwidth}{!}{%
\begin{tabular}{@{}llll@{}}
\toprule
