...
\label{sec:wacc}
The WACC represents a company’s cost of capital in which each source of capital is proportionately weighed. \Cref{eqn:wacc} displays the calculation of WACC \cite{dikov_understanding_2021}:
