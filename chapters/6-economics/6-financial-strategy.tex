...
\end{equation}
The risk-free rate, R_{f}, was determined using the yield of a 10-year government bond in China, equivalent to 3.28% (XX). The average market return, Rm, was based on the average yearly return of the Shanghai Composite Index between 2000 and 2018, equivalent to 12.76% (XX). The industry average beta for the speciality chemicals sector in China was found to be 0.99, used for B.
