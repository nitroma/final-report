...
Recent developments in flow chemistry and process intensification enable innovative designs of critical industrial processes to make them inherently safer. Nitroma will exploit the opportunity to transition  from batch to continuous nitration to safely manufacture important intermediates on a large-scale \cite{di_miceli_raimondi_safety_2015}. 
