...
A further sensitivity analysis was performed on the cooling water inlet temperature because the temperature inside the reactor needs to be well-controlled at all times. Cooling water temperature was simulated to vary by \mypm $\Delta$ 5 K. Although the cooling water is not expected to fluctuate by this amount since it is sourced from multiple, taking a conservative approach
