...
The model was implemented and optimised on COMSOL 5.6. TO ensure the reactor operates in optimal conditions, the following parameters were optimised: Concentric inner cooling pipe diameter and flowrate, coolant temperature, \ch{HNO3} : Toluene inlet ratio and the total number of tu
