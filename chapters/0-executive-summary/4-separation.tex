...
\begin{figure}[h]
    ...
    \begin{minipage}[t]{0.4\textwidth}
        \includesvg[width=0.4\linewidth,inkscapelatex=false]{chapters/3-separation/figures/Crystalliser_schematic.svg}
    ...
    \begin{minipage}[t]{0.55\textwidth}
        \includesvg[width=0.4\linewidth,inkscapelatex=false]{chapters/3-separation/figures/Wash_column_schematic_executive.svg}
