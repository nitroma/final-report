...
\begin{figure}[h]
    ...
    \centering
        \includesvg[scale=0.2,inkscapelatex=false]{chapters/3-separation/figures/Crystalliser_schematic.svg}
    ...
    \centering
        \includesvg[scale=0.2,inkscapelatex=false]{chapters/3-separation/figures/Wash_column_schematic_executive.svg}
