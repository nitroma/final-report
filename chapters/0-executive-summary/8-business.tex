...
To meet its \$22.5 million CAPEX, Nitroma will sell a \SI{45}{\percent} stake to private equity investors for \$10.3m and receive a \$12.3m loan from Chinese commercial banks at a \SI{5.35}{\percent} interest rate .
%This is motivated by the high price sensitivity and low brand loyalty of Nitroma’s customers.

\begin{wraptable}{r}{8cm}
\centering
\caption{Nitroma's KPIs compared to the industry average (damodar,p}
\label{KPI-ES}
\begin{tabular}{@{}l|l|l@{}}
\toprule
