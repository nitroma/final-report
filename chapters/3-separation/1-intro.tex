...
This report explains the design for the separation of \para-nitrotoluene (PNT) from a liquid stream consisting predominantly of PNT and \meta-nitrotoluene (MNT) with a trace amount of \ortho-nitrotoluene (ONT). The production of 4-aminobenzaldehyde (4-ABH) and 4-aminobenzoic acid (4-ABA), the final products of Nitroma's nitration plant, requires PNT as the precursor with at least \SI{90}{\percent} purity. Therefore, the separation of the nitrotoluene isomers holds a great significance and must be carefully considered and designed. \Cref{tab:inlet crystalliser} summarises the inlet conditions at stream 1-12 on the overall PFD in \Cref{app} for this separation. 
