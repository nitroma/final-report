...
There are two main types of melt crystallisers in industry: solid-layer crystalliser and suspension crystalliser. In solid-layer crystallisers, a layer of crystal grows perpendicular to a cooled wall into the bulk of the melt also known as the mother liquor. It is usually a multistage purification process. In contrast, crystallisation in suspension melt crystallisers is initiateed on cooled surfaces and the crystals are then scraped off. Crystal growth thus occurs on the crystals suspended in the melt \cite{myerson_handbook_2019}. \Cref{tab:crystallisertype} lists out the advantages and disadvantage of the two main crystalliser types discussed. 
