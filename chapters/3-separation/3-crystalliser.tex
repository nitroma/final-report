...
The crystalliser recovery, $r_c$, has been plotted against the volume of the crystalliser, $V$, in Figure

\begin{figure}[h]
    \centering
    \includesvg[scale=0.75,inkscapelatex=false]{chapters/6-economics/figures/Recovery_vs_volume_crystalliser.svg}
    \caption{Caption}
    \label{fig:my_label}
\end{figure}
