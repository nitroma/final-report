...
\end{equation}
This modified correlation has been used for design as it fits well with experimental data and gives an $R^2$ of 0.9901 as can be seen on \cref{fig:eutectic schematic}b.
