...
The crystalliser recovery, $r_c$, has been plotted against the volume of the crystalliser, $V$, in Figure \ref{fig:recovery vs volume crystalliser}. 

\begin{figure}[h]
    \centering
    \includesvg[scale=0.75,inkscapelatex=false]{chapters/3-separation/figures/Recovery_vs_volume_crystalliser.svg}
    \caption{The crystalliser recovery, $r_c$, plotted against the volume of the crystalliser, $V$, as calculated from Equations \ref{eq:amount solid A equilibrium} to \ref{eq:crystalliser volume}. }
