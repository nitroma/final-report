...
\begin{align}\label{eq: supersaturation ratio}
    \Delta C = C - C_{\mathrm{eq}}    S = \frac{C}{C_{\mathrm{eq}}}
\end{align}
...
\begin{minipage}[t]{0.5\linewidth}
    \centering
    \includesvg[scale=0.4,inkscapelatex=false]{figures/Crystalliser_schematic.svg}
...
\begin{minipage}[t]{0.5\linewidth}
    \centering
    \includegraphics[scale=0.3]{chapters/3-separation/figures/Crystalliser_GA.PDF}
