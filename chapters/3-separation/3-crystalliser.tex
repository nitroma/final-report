...
The (p-NT + m-NT) system exhibits a eutectic-forming solid-liquid phase behaviour. In such a system, depending on the composition, one of the two components is able to crystallise out from the homogeneous liquid as pure solid when the mixture is cooled below thermodynamic equilibrium. \cite{seader_separation_2011} Figure \ref{fig:eutectic schematic}a is a schematic of this process; here, starting from point 1 with temperature at $T_1$ and fraction of component A at $f_1$ on the solid-liquid phase boundary, when the mixture is cooled down to $T_2$, the liquid phase composition will become $f_2$ at equilibrium. Since $f_2$ is lower than $f_1$, this means pure solid A would crystallise out from the liquid, and its amount would be given by 
...
Figure \ref{fig:eutectic schematic}b is a plot of the solid-liquid phase diagram of the (p-NT + m-NT) system, where the experimental data, marked as blue circles, in Figure \ref{fig:eutectic schematic}b were obtained from DETHERM. Initially, van't Hoff's equation was used to predict 
...
The overall heat transfer coefficient consist of 4 resistance terms; R_1,R_w,R2 and R_f as the process side convective heat transfer, 
