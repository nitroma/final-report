...
The temperature whereat the crystalliser is to be operated, $T_{\mathrm{eq}}$ is designed to be 280 K. The choice is to ensure that the operating temperature of the crystalliser is well above the eutectic point as can be seen in Figure \ref{fig:eutectic schematic}
