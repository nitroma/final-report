...
\subsubsection{Material selection and shell design}

Austenitic stainless steel 304-S71 has been chosen from Table 2.3-5 of \textbf{BS5500: 1997} for constructing the crystalliser vessel. It has a nominal design stress, $f$, of 174 MPa. The minimum thickness for a cylindrical shell, $e_{\mathrm{cyl}}$, can be computed as 

\begin{equation}
    e_{\mathrm{cyl}} = \frac{p D_i}{2f - p}
\end{equation}

\noindent where $p$ is the design pressure of the vessel, and $D_i$ is the internal diameter of the vessel taken to be the same as $D$ as defined in Section \ref{sec: crystalliser mass balance}. For a vessel with ellipsoidal ends, the minimum thickness, $e_{\mathrm{end}}$, can be calculated using the methodology outlined in Section 3.5.2 of \textbf{BS5500: 1997}. The values of $e_{\mathrm{cyl}}$ and $e_{\mathrm{end}}$ hav

calculated as 0.36 mm and that of the doomed ends has been calculated as 0.918 mm. A corrosion factor of 1.5 mm has also been taken. In the end, a wall thickness of 3 mm has been chosen for both the shell and the dome ends. 
