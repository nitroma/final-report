...
\noindent where $L$ is the total length of the half pipe, $N$ is the number of revolutions in the helix, $p$ is the circumference of the helix, and $\delta$ is the pitch length. Like in Section 
