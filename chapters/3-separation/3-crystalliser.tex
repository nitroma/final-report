...
The value of $L_M$, however, does change sizeably with deviations in $K_B$ and $K_G$. This is because $L_M$ has a direct relationship with $G$, the growth rate, which is directly affected by $K_B$ and $K_G$. 
