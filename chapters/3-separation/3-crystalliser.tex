...
\noindent where $J_{c-c}$ is the contribution from crystal-crystal collisions, and $J_{c_s}$ is that from crystal-solid material collisions such as crystal-wall and crystal-stirrer. The forms of $J_{c-c}$ and $J_{c_s}$ are as following,
...
\begin{equation}
    J_{c_s} = k_{cs} \epsilon \rho_m (\Delta C)^b
\end{equation}
