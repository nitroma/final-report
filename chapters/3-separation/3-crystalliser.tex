...
\begin{equation}\label{eq:vantHoff}
    ln(x) = \frac{H_{f}}{R T}(\frac{T}{T_{m}} - 1)
\end{equation}
...
\noindent whence $C_{P,S}$ is the heat capacity of the solid crystal, $\Delta T$ is the degree of super-cooling as defined in Equation \ref{eq:deltaT}, and $H_{f}$ is the heat of fusion as in Equation \ref{eq:vantHoff}. Thus, the correlation directly relates $G$ to $\Delta T$.

The growth rate of the (p-NT + m-NT) system is estimated via Wilke-Chang's correlation,
