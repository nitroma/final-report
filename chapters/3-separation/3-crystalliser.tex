...
whence $T$ is the equilibrium temperature corresponding to concentration $c$ in the liquid, and $T_{eq}$ is the operated temperature to which the system has been super-cooled. Figure \ref{fig:supersaturation} is a schematic which explains these relations.

\begin{wrapfigure}{R}{0.3\linewidth}
\centering
\includesvg[width=0.3\textwidth,inkscapelatex=false]{chapters/3-separation/figures/Supersaturation.svg}
