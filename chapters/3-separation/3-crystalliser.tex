...
\noindent where $S$ is known as the supersaturation ratio. Like concentration basis, supersaturation can also be defined on a temperature basis, except that it is now known as degree of super-cooling:

\begin{equation}
     \delta T = T - T^*
\end{equation}

\noindent where $T$ is the actual temperature of the system and $T^*$ is the equilibrium temperature. 
