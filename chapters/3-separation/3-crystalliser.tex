...
\noindent It has been found that this correlation would give an $R^2$ of 0.9901 against experimental data; indeed, as can be seen on Figure \ref{fig:eutectic schematic}b, predictions from this correlation, shown as the blue curve, do fit well with the experimental results and hence has been used in the design.

In reality, however, the system needs time to reach thermodynamic equilibrium, which is why a crystalliser is needed. Kinetics of crystal formation in a MSMPR crystalliser will be explained in the following sections.

\subsection{Population and mass balances of MSMPR crystallisation}
