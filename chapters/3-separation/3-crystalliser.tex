...
\noindent where $k_{c-c}$ and $k_{c-s}$ are the rate law constants for the individual contributions, and $\epsilon$ is the quantity corresponding to the $N$ in equation \
