...
\noindent The volumetric flow rate, $Q$, has been approximated to be constant into and out from the crystalliser because the process is for condensed phase operations. \cite{levenspiel_chemical_1999} In the end, the mass of crystals per unit volume of the system, also known as magma density, $\rho_m$, is given by
