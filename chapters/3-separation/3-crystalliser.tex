...
A stream table for the crystalliser is available in Table \ref{tab:crystalliser stream table}. 5.2 kW of power is required for the refrigerator to remove 18 kW of heat from the crystalliser. 
