...
Supersaturation is the driving force for both nucleation and growth. Several measures exist to describe the degree of supersaturation. The commonest definition is via concentration basis,

\begin{equation}
    \delta c = c - c^*
\end{equation}

\noindent where $c$ is the actual concentration of crystallising component in the liquid and $c^*$ is the equilibrium concentration. Or it be defined as a ratio,

\begin{equation}
    S = \frac{c}{c^*}
\end{equation}

\noindent where $S$ is known as the supersaturation ratio. 
