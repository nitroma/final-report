...
\noindent where $J_{c-c}$ is the contribution from crystal-crystal collisions, and $J_{c_s}$ is that from crystal-solid collisions such as crystal-wall and crystal-stirrer collisions. The forms of $J_{c-c}$ and $J_{c_s}$ are as following,
