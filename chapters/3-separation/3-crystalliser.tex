...
Fouling is a big issue in crystallisation tanks as nucleation can form on the wall of the crystalliser, leading to a layer f crystallised solid product on the inner walls. No only does this lead to reduced solid product, but also leads to increase heat transfer cost due to the higher heat transfer resistance caused by the layer of fouling coating the pipe. To account for fouling in this design, an additional resistance will be added to the aforementioned resistances in series in section %quote section% 
