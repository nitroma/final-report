...
\noindent where the value of $K_B$ has been estimated to be in the order of 10$^{13}$, provided that all the quantities in Equation \ref{eq:secondary nucleation final expression} are in SI units \cite{bauer_contact_1974}. Sensitivity analysis for value of $K_B$ is available in \ref{sec:kinetics sensitivity} The exponent, $b$, has been taken as 1. 
