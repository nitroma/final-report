...
Secondary nucleation takes place when crystals of the species are already present. \cite{Richardson} When no seeding is introduced, contact secondary nucleation between existing crystals themselvese, 
