...
whence $T$ is the equilibrium temperature corresponding to concentration $c$ in the liquid, and $T_{eq}$ is the operated temperature to which the system has been super-cooled. Figure 

\begin{wrapfigure}{R}{0.5\linewidth}
\centering
\includesvg[width=0.5\textwidth,inkscapelatex=false]{chapters/3-separation/figures/supersaturation.svg}
