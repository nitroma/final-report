...
, as the thickness of the fouled layer on the outer side of the half pipe coil increases, there is a decrease in the overall heat transfer coefficient. Even with a small encrustation, there is a significant initial drop in the coefficient. A   This addresses the need for some resolution 
...
Austenitic stainless steel 304-S71 has been chosen from Table \textbf{BS5500: 1997} for constructing the crystalliser. 
