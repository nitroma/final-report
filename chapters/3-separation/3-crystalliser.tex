...
whence $T$ is the equilibrium temperature corresponding to concentration $c$ in the liquid, and $T_{eq}$ is the temperature the system has been cooled to and the equilibrium temperature corresponding to $c_{eq}$. 
