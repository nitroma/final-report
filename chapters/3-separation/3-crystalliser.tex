...
, as the thickness of the fouled layer on the outer side of the half pipe coil increases, there is a decrease in the overall heat transfer coefficient. Even with a small encrustation, there is a significant initial drop in the coefficient. For example, a 1mm layer of fouling incurs a   This addresses the need for some resolution 
