...
where $\Dot{m}_f$ is the feed mass flow rate, $C_{pi}$ is the specific heat capacity of the mixture, $\Delta H_{C}$ is the enthalpy of crystallisation $\Dot{m}_{c}$ $T_{in}$ and $T_{out}$ are the inlet and outlet temperatures of the MSMPR respectively, 
