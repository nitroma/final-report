...
\begin{equation}\label{eq:amount solid A equilibrium}
    \dot{M_{solid}} = \frac{\dot{M_{total}} (x_1 - x_2)}{1 - x_2}
\end{equation}

\noindent where $\dot{M_solid}$ is the equilibrium mass flow rate of crystal solid A and $\dot{M_{total}}$ is the total mass flow rate of A and B. 
