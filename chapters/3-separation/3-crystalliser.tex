...
A suitable estimate for the service side fouling resistance due to the ethylene glycol solution was found to be . To look at the process side fouling, the thickness of fouling has been varied to analyse its effect on the heat transfer area and the overall heat transfer coefficient and whether the effect needed to be addressed with any further considerations.:
