...
Four ports are needed on the crystalliser vessel, namely the inlet, the outlet, and two sightholes. Per requirement of BS470: 1984, two sightholes with minimum diameter of 30 mm are needed. The ports have been designed by choosing standard sized pipes as given in Table 1 of \textbf{BS1600: 1991}. Schedule 80 pipes with nominal pipe size (NPS) of 2 in have been chosen for all ports. 

The crystalliser consists of a cylindrical shell and two domed ends. 
