...
The kinetic rate constants employed in Sections \ref{sec:secondary nucleation} and \ref{sec: crystal growth} were estimates and should have been scrutinised in greater details; specifically, $K$ and $K$ in Equations \ref{eq:secondary nucleation final expression} and \ref{eq:ratio of growth kinetics} 
