...
A suitable estimate for the service side fouling resistance due to the ethylene glycol solution has been found to be \SI{0.000352 W$^{-1}$ m$^2$ K \cite{noauthor_fouling_2021}. This resistance can be considered to have a negligible impact on the vessel design. 
