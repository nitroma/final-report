...
where $R_1$ is the process side convective heat transfer term,$R_w$ is the conductive heat transfer,$R_2$ is the service side heat transfer and $R_f$ is additional resistance due to fouling. For inital calculations, resistance due to fouling will be 
