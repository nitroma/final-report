...
Figure \ref{fig:eutectic schematic}b is a plot of the solid-liquid phase diagram for the (p-NT + m-NT) system, where component fraction on the horizontal axis has been defined for p-NT. Experimental data were obtained from DETHERM and are marked on this Figure as green circles. Initially, van't Hoff's equation was used to give continuous predictions of the solid-liquid phase boundary on the right-hand-side of the eutectic point,

\begin{equation}
    
\end{equation}

\noindent However, as can be seen on Figure \ref{fig:eutectic schematic}b, 
...
\begin{equation} \label{eq:energy balance}
    U =  \left(\Dot{m}_{f}C_{pi}(T_{in}-T_{out})+ \Delta \right) H_{C}\Dot{m}_{c}
\end{equation}
