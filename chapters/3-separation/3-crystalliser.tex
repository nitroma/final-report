...
\end{equation}
This modified correlation has been used fo give an $R^2$ of 0.9901 against experimental data; indeed, as can be seen on \cref{fig:eutectic schematic}b, predictions from this correlation, shown as the blue curve, do fit well with the experimental results, hence it has been applied for the design.
