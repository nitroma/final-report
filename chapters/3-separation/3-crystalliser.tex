...
where L is the total length of the half pipe, N is the number of revolutions in the helix, C is the circumference of the coiling and P is the "pitch" or height of a single coil
