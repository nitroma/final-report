...
\subsection{Steady State Model}  \textcolor{red}{we could put this in Appendix if we want, it's just repeating equations from literature.} 
...
\begin{equation}
\frac{\Delta P_{l,filtration}}{L_{filtration}}=\frac{\epsilon \varmu_{l}}{B_{filtration}}\left(\frac{\phi_{ml,filters}}{\epsilon A_c} - \frac{\phi_{s,filters}}{1-\epsilon A_c}\right)
\end{equation}
