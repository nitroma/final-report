...
Practically, during operation of the hydraulic column there will be variations in the length of the filtration, stagnant and wash section with time. Therefore, on excel simulations of variable filtration and wash section lengths were implemented. This was done to determine maximu
