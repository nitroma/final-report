...
\begin{tabular}{llll}
\multicolumn{2}{c}{Inputs}         & \multicolumn{2}{c}{Parameters}           \\
Feed Flow (m3/s)                &  & Porosity, epsilon                     &  \\
Steer Flow (m3/s)               &  & Filtration Permeability Constant (m2) &  \\
Crystal concentration (v/v)     &  & Wash Permeability Constant (m2)       &  \\
Flow resistance factor (Pas/m3) &  &                                       & 
\end{tabular}
\end{table}
