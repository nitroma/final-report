...
The wash column under steady state operation will present 3 layers of a filtration, stagnant and wash zone. Within the filtration and stagnant it is assumed that the porosity and permeability remain constant. Since the crystals form a densely packed column $\epsilon$ was taken as 0.6. Due to the wash-liquid crystallisation at the wash zone there is a change in porosity and permeability. The consolidation of the crystal bed were neglected in this model. According to the literature, the production capacity is in the same order of magnitude as their validation experiment therefore the model could still be applicable for this 
...
The volume balance at the melting circuit is based on the assumption that crystals are molten the moment they enter the melting circuit. 
