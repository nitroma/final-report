...
For the operation of the crystalliser, constant inspection is recommended. With periodic frequency, hot fluid should be run through the cooling coil to melt the fouling caused by PNT solid deposition on the vessel; mechanical cleaning is also recommended at lower frequency. The cooling coil should also be chemically cleaned with periodic frequency. 
