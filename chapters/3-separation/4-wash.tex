...
\Cref{tab:wash column stream table} is a stream table for the hydraulic wash column. For the electric melter, H301, at the bottom, a \SI{3.69}{\kW} heating duty is required.  
