...
The total length of the top section remains constant. The length of the filtration section $ L_{\mathrm{filtration}} (m)$,  was derived from the solid balance in the top section where $\alpha_1 (m^3/m^3)$ is the crystal fraction in the feed slurry, $\alpha_2 (m^3/m^3)$ is the crystal fraction in the slurry section, $\epsilon$ is the porosity in the filtration and stagnant section and $A_c (cross sectional $
