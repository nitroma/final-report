...
For the operation of the hydraulic column, it is possible to vary the lengths of the filtration, stagnant, and wash sections. Therefore, modelling with variable filtration and wash section lengths were implemented to determine the effect on pressures at different sections of the column. With proper controls in place, the sections should not vary significantly during normal operation, therefore variation in filtration and wash section would be designed to be between 0.27 to 0.30 m.  
