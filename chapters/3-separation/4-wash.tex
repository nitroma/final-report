...
This section details the design of 
...
Table \ref{tab:wash column stream table} is a stream table for the hydraulic wash column. For the melter, H301, at the bottom, a XX kW heating duty is required.  
