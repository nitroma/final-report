...
\begin{tabular}{@{}lS[table=format=1.3e2]s|lSs@{}}
\toprule
\multicolumn{3}{c|}{\textbf{Inputs}}              & \multicolumn{3}{c}{\textbf{Parameters}}          \\ \midrule
$\phi_{feed}$    & 4.27e5 & \cubic\m\per\s        & $\epsilon$                & 0.45     & {-}       \\
$\phi_{steer}$   & 1.8e5  & \cubic\m\per\s        & $\mathrm{B_{filtration}}$ & 7.87e-14 & \square\m \\
