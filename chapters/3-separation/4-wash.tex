...
The permeability constants were determined  from Carman-Kozeny equation shown below. the commonly accepted value for Kozenzy constant is 5.
...
\end{equation}
 ...
 based on the assumption that the crystal particles are spherical, therefore, the specific surface area, 
