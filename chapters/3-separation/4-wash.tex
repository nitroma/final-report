...
$\Delta P_{l,\mathrm{filtration}}, \Delta P_{l,\mathrm{wash}}, \Delta P_{l,\mathrm{stagnant}}$ (Pa) is the liquid pressure drop across the filtration, wash and stagnant section. $B_{\mathrm{filtration}},B_{\mathrm{wash}}$ and $B_{\mathrm{stagnant}}$ (m$^2$) is the permeability constant for filtration, wash and stagnant sections. 
