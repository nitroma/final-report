...
Overall volume balance at the top section is shown below where $\phi_{\mathrm{feed}} (m^{3}/s)$ is the feed flow rate, $\phi_{\mathrm{steer}} (m^{3}/s)$ is the steering flow, $\phi_{\mathrm{filters}} (m^{3}/s)$ is the , $\phi_{\mathrm{ml,filters}} (m^{3}/s)$
