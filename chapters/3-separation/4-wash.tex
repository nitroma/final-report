...
The permeability constants were determined  from Carman-Kozeny equation shown below. It is based on the assumption that the crystal particles are spherical, the Kozenzy constant has a commonly accepted value of 5 $K"$ = 5. 
