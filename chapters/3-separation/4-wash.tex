...
Could include a compressive stress profile across the column. Compressive stress impacts the permeability of the bed and causes deformation of the crystal particles.However, since the crystal particles size or shape is not of significance as 
