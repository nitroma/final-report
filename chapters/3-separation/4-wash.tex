...
The liquid pressure drop across each section were calculated with the following modified Darcy's law equation. $\Delta P_{l,\mathrm{filtration}}, \Delta P_{l,\mathrm{wash}}, \Delta P_{l,\mathrm{stagnant}} (bar)$ is the liquid pressure drop across the filtration, wash and stagnant section. 
