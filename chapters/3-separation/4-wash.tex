...
The amount of crystallised material was calculated based on a heat balance and temperature difference between the feed and the melt. This assumes the total cooling capacity of the crystals is used to crystallise the wash liquid. $C_s (m^3/s)$ is the solidification rate of wash liquid to s at the wash front, $C_l (m^3/s)$ is the solidification rate at the wash front 
\begin{equation}
