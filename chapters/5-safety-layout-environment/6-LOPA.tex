...
\begin{itemize}
\item \textbf{IC1} - pressure trasnmitter, PT201 erroneously reads low 
\item \textbf{IC2} -  PIC201 set point high in error
...
\item Interlock systems to automatically shut down plant (or a specific section of the plant) in case of critical condition %cross ref to controls
