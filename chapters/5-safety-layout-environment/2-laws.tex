...
Is a legislative act that has been put in place to regulate industrial pollutant emissions, with the goal of reducing these emissions for the protection of human health and the environment. In compliance to the directive, Nitroma will make every effort to optimise our whole environmental performance, from emissions to the air, soil and water, to energy and noise pollution. Following the directive, Nitroma will ensure emission limits are not only met, but minimised as much as possible. 

%https://ec.europa.eu/environment/industry/stationary/ied/legislation.htm

\paragraph{Air Quality Standards Regulations 2010:}

This regulation imposes maximum limits for point source gaseous pollutants, including nitrogen oxide, carbon monoxides and aromatic compounds. The aim of this regulation is to limit the emission of harmful air pollutants via industrial practises, with the ultimate goal of achieving 'cleaner air'. 

%https://www.burges-salmon.com/news-and-insight/legal-updates/meeting-eu-air-quality-standards-is-the-uk-blowing-hot-and-cold/

\paragraph{Waste water treatment limits:}

The quality of wastewater discharged is assessed against set compliance limits by the Environmental Agency to regulate WWTW. Look-up Table (LUT) and maximum compliance limits for BOD and COD. Discharge to drinking water sensitive areas will have site-specific total nitrogen limits with annual mean concentration limit. 

The environmental agency has set maximum limits for wastewater, including chemical oxygen demand, biological oxygen demand and total nitrogen content. Nitroma must meet these limits, in order to comply with the IED. 
