...
Figure -- shows the wind profile in Nanjing, China. The wind frequently moves from west to east. The waste water treatment includes stacks with gaseuous emissions. Therefore, the treatment units were places in the above the production area, further away from the control and admin buildings. It was also placed in the north east side, downwind to the wind profile so that the plumes will be moving away from the sit
