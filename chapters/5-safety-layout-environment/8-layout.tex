...
All raw materials will be stored in atmospheric storage tanks provided with full bund, excluding hydrogen storage tanks. 

Hydrogen should be stored in pressure container. 

Product storage:
(4-aminobenzoic acid, 4-aminobenzaldehyde, o-toluidine)

All products will be stored in atmospheric storage tanks provided with full bund to avoid spillage of toxic materials.  
