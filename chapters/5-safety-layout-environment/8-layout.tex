...
(Lee's) Storage will be segregated from the production area to avoid the risk of fire propagating from the production area to the storage tanks. The raw material and product storages will be placed in one area whilst the waste storage will be placed in closer proximity to the waste treatment plant for easy access. The raw material loading and product unloading terminals will be separated. Due to the hazardous nature of the substances they will be placed away from the entrance. 

Raw materials, excluding hydrogen,  will be stored in atmospheric storage tanks provided with full bund. Only hydrogen would be stored in a pressure container since it'll be stored at 5 atm, above atmospheric pressure. All products will be stored in atmospheric storage tanks provided with full bund to avoid spillage of toxic materials.  

%More info will be needed on waste stream, incomplete
