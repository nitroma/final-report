...
Due to the continuous nature of the plant, liquid effluent streams will be continually discharged and so there must be a wastewater treatment plant that is able to manage this demand sufficiently. The majority of aqueous waste streams to treated contain 

%should there be storage and collection?
%pre-treatment for solids?
%does any vapour need to be removed from the liquid
