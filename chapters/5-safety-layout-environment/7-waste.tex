...
Due to the continuous nature of the plant, liquid effluent streams will be continually discharged and so there must be an on-site wastewater treatment plant that is able to manage this demand sufficiently. Table %label the table 
shows that majority of waste streams have a high organic content (reflected in the COD values obtained) 
