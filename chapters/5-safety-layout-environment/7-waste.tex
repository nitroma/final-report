...
\noindent where $C$ is the concentration of the pollutant, $Q$ is the emission rate, $u_H$ is the windspeed at the effective height of the stack, $\sigma_{y}$ and $\sigma_{z}$ are the horizontal and vertical dispersion coefficient respectively and $H$ is the effective stack height. 
