...
All chemicals in the process were given a rating between 0-1, indicating that these substances being used are relatively stable, however controls will be put in place to ensure that both the reaction conditions and storage conditions are met, with defined 
