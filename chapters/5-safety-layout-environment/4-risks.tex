...
\begin{itemize}
    ...
    \item ensure workforce are fully trained, following MSDS procedures and guidance for each of the substances in the process
    ...
    \item provision of appropriate PPE and placement of emergency showers, eye-wash unit and respirators
\end{itemize}
