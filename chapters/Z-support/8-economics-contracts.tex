...
\end{table} 
\begin{table}[H]
\includegraphics[clip, trim=0cm 8cm 0cm 0cm, width=\linewidth]{chapters/Z-support/attachments/Cash2.pdf}
\end{table}
\begin{table}[H]
\includegraphics[clip, trim=0cm 8cm 0cm 0cm, width=\linewidth]{chapters/Z-support/attachments/Cash3.pdf}
\end{table}
 \end{landscape}
