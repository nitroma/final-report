...
\includegraphics[clip, trim=1cm 0cm 1cm 1cm, width=\linewidth]{chapters/Z-support/attachments/KPI1.pdf}
\end{table}

\begin{table}
\includegraphics[clip, trim=1cm 0cm 1cm 1cm, width=\linewidth]{chapters/Z-support/attachments/KPI2.pdf}
\end{table}
