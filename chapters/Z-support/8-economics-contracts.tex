...
\includegraphics[clip, trim=0cm 10cm 0cm 1cm, width=\linewidth]{chapters/Z-support/attachments/Cash1.pdf} \\

\includegraphics[clip, trim=0cm 10cm 0cm 1cm, width=\linewidth]{chapters/Z-support/attachments/Cash2.pdf}
\end{table}
