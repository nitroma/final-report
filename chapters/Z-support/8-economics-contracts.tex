...
\includegraphics[clip, trim=1cm 8cm 1cm 1cm, width=\linewidth]{chapters/Z-support/attachments/KPI1.pdf}
\end{table}
...
\label{tab:Income}
  \caption{Cash flow for Nitroma (2021-2043)}
\includegraphics[clip, trim=1cm 5cm 1cm 1cm, width=\linewidth]{chapters/Z-support/attachments/Cash1.pdf}
\end{table}

\begin{table}
\includegraphics[clip, trim=1cm 5cm 1cm 1cm, width=\linewidth]{chapters/Z-support/attachments/Cash2.pdf}
\end{table}
