...
\label{sec:economics-supporting}

\subsection{Price agreement with DEdwards Corp plc}
\label{sec:price-agreement}
Attached below is the price contract that was agreed with David Edwards on March 2021.
...
\includegraphics[clip, trim=0cm 3cm 0cm 0cm, width=\linewidth]{chapters/Z-support/attachments/Cash1.pdf}
\end{table} 

\begin{table}[H]
\includegraphics[clip, trim=0cm 3cm 0cm 0cm, width=\linewidth]{chapters/Z-support/attachments/Cash2.pdf}
\end{table}

\begin{table}[H]
\includegraphics[clip, trim=0cm 0cm 0cm 0cm, width=0.9\linewidth]{chapters/Z-support/attachments/Cash3.pdf}
\end{table}
 \end{landscape}
