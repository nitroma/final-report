...
\includegraphics[clip, trim=0cm 15cm 0cm 1cm, width=\linewidth]{chapters/Z-support/attachments/KPI1.pdf} \\

\includegraphics[clip, trim=0cm 15cm 0cm 1cm, width=\linewidth]{chapters/Z-support/attachments/KPI2.pdf}
\end{table}
\end{landscape}
...
\includegraphics[clip, trim=1cm 8cm 1cm 1cm, width=\linewidth]{chapters/Z-support/attachments/Cash1.pdf}
\end{table}
...
\includegraphics[clip, trim=1cm 5cm 1cm 1cm, width=\linewidth]{chapters/Z-support/attachments/Income1.pdf}
\end{table}
