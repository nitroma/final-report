...
\newpage
\subsection{Flue gas stack}

\begin{table}[H]
    \centering
    \begin{tabular}{@{}l|l@{}}
    \toprule
      \textbf{Equipment label}  & \\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth,scale=0.5]{chapters/Z-support/figures/Flue gas stack.jpg}
...
Average flue gas temperature    & 140                 & °C             \\ \bo
