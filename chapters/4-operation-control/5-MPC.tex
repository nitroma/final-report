...
Good formulation of the optimisation algorithm for MPC includes the setting of inequality constraints that satisfy quality requirements, operational limits, safety considerations and saturation of actuators. Summarised below are the 
