...
In conclusion, proper model formulation and implementation of the MPC can serve as a useful technique to effectively manage interactions between control loops in Nitroma's complex plant with a multivariate control problem.
