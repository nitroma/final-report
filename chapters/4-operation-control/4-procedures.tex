...
\begin{itemize}
    \item Step 1-5: Stop the steam feed to reboiler using FCV-207. The hydrogen and liquid feeds are gradually stopped using V206 and V202, and are finally shut off using SOV-201 and SOV-202. Care must be taken to turn the pump off before it runs dry. The reactor is vented by keeping the vapour outlet port and FCV-202 
