...
\begin{itemize}
    ...
    \item Step 15-18:The reactor and column are physically disconnected by removing isolation valves and blanking open ends. Detectors need to be checked for a safe atmosphere inside the unit before personnel entry is granted.
\end{itemize}