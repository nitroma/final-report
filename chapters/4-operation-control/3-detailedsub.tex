...
In the event of large shock or disturbances in a short timeframe, manual actions conducted by the operator may fail to return the plant to its normal operating conditions, thus threatening the safety of the process. Hence executive high-high  alarms

 Hence, emergency trips are designed and implemented to bring the plant into a safe state without any need for manual intervention when extremely hazardous conditions are detected in the plant and the risk of an incident is high.
 
 Alarms also act as a layer of protection to ensure the risk is as low as reasonably practicable (ALARP) (see LOPA in Safety Section 3.6). 
