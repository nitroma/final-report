...
In principle, good control of MIMO systems will require knowledge about the dynamics of the system. Each controlled variable should be controlled by the manipulated variable that has the largest direct impact on it, which can be deduced from the individual transfer functions of each pairing.
