...
The full list of regular and executive alarms, including the manual operations to be taken by the operators and the level of priority, can be found in \Cref{tab:alarms}.
