...
Process dynamics data can be utilised by the Relative Gain Array method to deduce the best manipulated variable pairing for each controlled variable. This is determined by the relative gain between a controlled variable and manipulated variable, which is defined as the ratio of the steady state open-loop gain and closed-loop gain (see Equation \ref{eqn:relative-gain}). 
