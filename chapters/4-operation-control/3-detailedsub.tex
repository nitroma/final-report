...
The liquid level at the bottom of the distillation column S201 is an important inventory to control in order to prevent the reboiler from drying up and weeping to occur in the column. Stable column operation depends on a certain level of liquid pooling at the bottom of the column. 
\begin{figure}[H]
    \centering
