...
Table XXX shows a summary of the control loops in the plant sub-section. A total of 11 variables were controlled using a variety of strategies such as feedback, feedforward, cascade, ratio and inferential control in order to ensure stable operation of the units in the sub-section.
