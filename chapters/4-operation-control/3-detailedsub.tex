...
The activation of an executive alarm leads in most cases to an emergency partial or complete plant shutdown. In partial shutdown, the production   In a partial plant  safety interlocks were designed to 
