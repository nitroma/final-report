...
The established controls so far have assumed a single-input, single-output (SISO) system, where one manipulated variable only affects one control variable. In reality, it is likely that manipulating one variable will affect multiple controlled variables. For example, controlling reboiler duty would affect both the column temperature and bottoms flow rate. 

In principle, good control of 
