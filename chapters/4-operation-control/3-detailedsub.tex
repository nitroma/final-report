...
The agreed subsection begins with a gaseous \ch{H2} stream and liquid methanol and o-nitrotoluene stream. The \ch to a trickle bed reactor R201. 

\subsection{Key control loops}
Table XXX shows a summary of the detailed control loops designed for the agreed sub-section of the plant. A total of 11 variables were controlled using a variety of strategies such as feedback, feedforward, cascade, ratio and inferential control in order to ensure stable operation of the units in the sub-section.
