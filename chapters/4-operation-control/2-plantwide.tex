...
Electricity is not only key to supplying heat to process fluids through electric heaters and to running the pumps and fans, it is also essential for the actuation of electrical control valves for flow are pressure. If power is lost, 

If electricity supply is lost, then pumps stop running and the actuation method of electrical control valves stops functioning. In this scenario, ensuring equipment enters a fail-safe state is crucial in preventing accidents. Control valves can be set to fail-open, fail-closed or fail as is. For electric actuation, this is provided by back-up battery packs or mechanical spring setups. Managing the restart of the plant upon power restoration is just as important, as equipment may automatically begin operation before other sections are manually restarted and reset. Back-up power supplies and implementation of robust interlocks can reduce the risk of process upsets upon temporary losses of power, but procedures should be in place for bringing the plant to a safe state for longer outages. 
