...
\begin{itemize}
    ...
    \item The reactor temperature HH alarm is 3°C below the flash point of o-tol.
    \item The reactor pressure and gas pressure HH alarms are 2 bar higher than the set point.
