...
\begin{itemize}
    ...
    \item The HH alarms for the cooling water temperature were designed to sound when the temperature was so high that it could no longer remove, with a the set point flowrate, the same amount of heat that is removed by a 60\% lower cooling water flowrate at \SI{16}{\celsius}.
\end{itemize}
