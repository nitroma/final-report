...
\paragraph{Shutdown of downstream units (Step19)}
    \begin{itemize}
        ...
        \item The total time taken to shutdown the detailed plant sub-section up to the point of placing shutdown blinds is 195 minutes.
        \item This time is scaled for downstream shutdown according to the number of units with inventory, i.e. 10/6 * 19 would be 6 * 10 = 60 minutes.
    \end{itemize}