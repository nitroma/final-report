...
For a plant operating 310 days per year, ASPEN simulations found that 626 tonnes/year of 99\% pure o-Toluidine, 500 tonnes/year of 99.3\% pure Aminobenzaldehyde and 107 tonnes/year of pure Aminobenzoic acid could theoretically be produced by Nitroma's .

%To develop the adapted synthesis route into a plant for the continuous production of atorvastatin calcium, it was necessary to determine the separation techniques and reactor types that would be required for a continuous process, which is not commonly carried out in industry due to the increased difficulty in quality control. The Arrhenius rate laws for each of the reactions were estimated using functional group chemistry with the constants being calculated using the literature data for temperature, conversion and reaction time. The reactions were then modelled under flow conditions in the appropriate reactors using ASPEN Plus to give approximations of the required sizings and residence times. Likewise, were the various separators, with the separation quality being estimated using the Joback group contribution method to estimate the thermodynamic properties.
