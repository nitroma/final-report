...
At industrial scale, nitration is mostly carried out in batch or semi-batch reactors to control  \cite{booth_nitro_2000,dugal_nitrobenzene_2005}.  

%In order to control the temperature rise due to the exothermicity of the reaction, the nitration of toluene is generally carried out in a fed batch (semi-batch) reactor.
