...
\subsection{Heat integration}%Bryan %0.5-1page


\section{Points of innovation}

\subsubsection{Continuous process}
Nitration of substituted amines is typically an industrial batch process due to the high risk of thermal runaway if the highly exothermic reaction gets out of control []. Nitroma designed an entirely continuous process 
