...
\centering
    ...
    \label{tab:product}
\resizebox{\textwidth}{!}{\begin{tabular}{l|S[table-format=4.2]S[table-format=1.1]lS[table-format=7.0,round-mode=figures,round-precision=2]|ll|lll|llc}
\toprule
                                          & \multicolumn{4}{c}{Economic potential   (\SI{29}{\percent})}                                & \multicolumn{2}{|c}{\splitcell{Process\\  complexity (\SI{14}{\percent})}} & \multicolumn{3}{|c|}{EHS (\SI{57}{\percent})}     &                       &                          &                           \\ \cmidrule{2-10}
                                          & {\splitcell{Price\\(\si{\USD\per\kg})}} & {\splitcell{CAGR\\(\%)}} & \rcell[30mm]{Average producer market share (\%)} & {\splitcell{Demand\\(\si{\tonne\per\year})}} & \rcell{Number of reactions} & \rcell[25mm]{Max selectivity to toluene (\%)} & \rtext{Health} & \rtext{Flammability} & \rtext{Instability} & AHP & TOPSIS & Rank \\ \midrule
...
Direct hydrogenation of 4-nitrobenzaldehyde and 4-nitrobenzoic acid using \ch{H2} was also considered as an option as pressurised hydrogen gas is readily available commercially. The highly flammable nature of hydrogen gas poses a significant hazard to this plant. Furthermore, alternative hydrogen donors such as formic acid and isopropanol are also similarly inexpensive and easily obtainable commercially, offsetting the main benefit of the direct hydrogenation method \cite{wang_golden_nodate}. 
