...
%MAUT was eliminated due to the large amount of input data required and the limited information this project has collected. 
%Outranking methods, ELECTRE and PROMETHEE were also eliminated as the strength and weakness of alternatives were hard to determine with ELECTRE results and methods for assigning certain values in the PROMETHEE analysis were not clearly provided in literature.8 Disadvantages of TOPSIS and AHP however still exist and will be discussed later in this section.


%  AHP and TOPSIS were selected due to their relative ease of usage with minimum subjectivity. Other methods were ruled out due to the lack of information for their inputs. Furthermore, some methods involve a single stakeholder making the final decision, and could be highly unreliable in the absence of other stakeholders’ perspectives (Zolfani & Zavadskas, 2013). 
