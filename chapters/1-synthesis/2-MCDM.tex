...
\resizebox{\textwidth}{!}{\begin{tabular}{l|S[table-format=4.2]S[table-format=1.1]lS[table-format=7.0,round-mode=figures,round-precision=2]|ll|lll|S[table-format=1]S[table-format=1]c}
\toprule
                                          & \multicolumn{4}{c}{Economic potential   (\SI{29}{\percent})}                                & \multicolumn{2}{|c}{Process   complexity (\SI{14}{\percent})} & \multicolumn{3}{|c|}{EHS (\SI{57}{\percent})}     &                       &                          &                           \\ \cmidrule{2-10}
