...
\begin{figure}[h]
    \centering
    \subfloat[AHP]{{\includegraphics[width=.46\linewidth]{chapters/1-synthesis/1-Figures/AHP_product.pdf} }}
    \qquad
    \subfloat[TOPSIS]{{\includegraphics[width=.46\linewidth]{chapters/1-synthesis/1-Figures/TOPSIS_product.pdf} }}
...
\begin{figure}[h]
    \centering
    \subfloat[AHP]{{\includegraphics[width=.46\linewidth]{chapters/1-synthesis/1-Figures/AHP_nitration.pdf} }}
    \qquad
    \subfloat[TOPSIS]{{\includegraphics[width=.46\linewidth]{chapters/1-synthesis/1-Figures/TOPSIS_nitration.pdf} }}
...
During catalytic hydrogenation, nitrocompounds are usually reduced with  hydrogen in the presence of a solid catalyst [].

Most large volume aromatic and aliphatic amines are made by continuous high pressure catalytic hydrogenation. Nitro compounds can also be reduced in good yields with iron and hydrochloric acid in the Bèchamp process. Aromatic amines are usually made by hydrogenating the corresponding nitro compound, whereas the aliphatic amines generally start with the corresponding nitrile. In the Bèchamp process, nitro compounds are reduced to amines in the presence of iron and an acid. This is the oldest commercial process for preparing amines, and is still used in the dyestuff industry. The method of reducing aromatic nitro compounds with divalent sulfur is known as Zinin reduction. This reaction is carried out in a basic media using sulfides, polysulfides, or hydrosulfides as the reducing agent.

In catalytic hydrogenation, a compound is reduced with molecular hydrogen in the presence of a catalyst.

Catalytic hydrogenation is the most efficient method for the large‐scale manufacture of many aromatic and aliphatic amines.

Catalytic hydrogenations can be carried out in the vapor or in the liquid phase, either with or without the use of a solvent. The vapor‐phase reaction is limited to compounds that are thermally stable and relatively volatile. High boiling compounds and those that are thermally unstable must be hydrogenated in the liquid phase.

Most large scale industrial processes operate with essentially pure hydrogen, but hydrogen mixed with carbon monoxide or inert gases can also be used. 

The use of a solvent in a catalytic hydrogenation can strongly influence the rate and selectivity of the reaction (57). Using a solvent can simplify hydrogenation of solids or highly viscous materials by making them easier to handle. A solvent can be used to moderate the heat of reaction, which can be quite large. A solvent can influence the solubility of hydrogen in the liquid phase, which can have a marked difference on the rate of reaction. A solvent can also enhance selectivity by altering the polarity of the reaction medium. Since many by‐product reactions are second order in the liquid components, and the hydrogenation reaction is first order, dilution using a solvent can further influence the selectivity to the desired products (58). Since hydrogenation processes usually operate under high pressure, the reaction temperature can be significantly above the boiling point of the solvent. This needs to be taken into consideration when designing a process, so that the hydrogen partial pressure is maintained at a sufficient level to allow the reaction to proceed as planned. The benefits of using a solvent need to be weighed against the reduced productivity of a reactor and the costs of separating and recycling the solvent.

In practice, low molecular weight alcohols, particularly methanol, or ethanol, are the most commonly used hydrogenation solvents. Other solvents that have been used include acetic acid, acetone, ammonia, benzene, glycerol, ethylene glycol, hydrochloric acid, sulfuric acid, and water. When applicable, the product of the hydrogenation can also be used as a solvent (59). Recently, secondary alcohol (60) and dialkyl ether (61) solvents have been mentioned as beneficial solvents for hydrogenation. Finally, a new development is the use of supercritical fluids as solvents for hydrogenations (62, 63). The benefits operating in the critical region of a solvent are due to the single phase behavior of the system, resulting in high concentrations of hydrogen at the catalyst surface. This results in a dramatic increase in rates, coupled with ease of separation of the solvent. The use of a supercritical solvent typically requires much higher pressures than typical hydrogenations, so the benefits of using such a solvent needs to be evaluated against the increased capital and operating costs.

In this process, the water of reaction is removed by circulating excess hydrogen through the reaction mixture so as to keep the mixture in the reactor single phase, which was found to keep the reaction rates high. The catalyst was either a supported nickel, cobalt, or copper. ICI patented a process whereby both aniline and water were removed from the reactor by operating at the boiling point of the reaction mixture, allowing for efficient temperature control of the reaction (90). Aniline could then be returned to the reactor to maintain a single phase in the reactor. This reaction was run at 150–250°C and at pressures between 5 and 10 atm. The catalyst system was a supported nickel Organic bases could be used to control by‐product make. ICI later patented improved nickel and cobalt catalysts for nitrobenzene hydrogenation (91) DuPont had earlier patented a palladium or palladium/platinum on carbon catalyst for aniline production (92). This catalyst system has been studied by Mitsui Toatsu, which claims that the addition of zinc compounds to the reaction mixture and the addition of carbon monoxide to hydrogen keeps nitrobenzene concentrations to low levels in the product and reduces formation of undesired by‐products (93). An interesting process had been proposed by First Chemical Corp, in which both m‐phenylene diamine and anline could be produced in the same hydrogenation reactor using a palladium on carbon catalyst (94). 

The reaction is often carried out in a  solvent for various reasons, such as in order to dissolve solid reactants and products, to absorb the exothermicity of the reaction, to suppress reaction rates in highly exothermic reac- tions, and to keep the catalyst surface free from impurities and carbonaceous deposits. It has been shown that the nature of the solvent employed also has a significant effect on the rate and selectivity of the reaction

Batch liquid‐phase catalytic hydrogenation is a common process for the production of lowervolume specialty toluidines or amines too high in molecular mass or too sensitive for vapor‐phase reactions. In these cases, liquid nitro compounds can either be reduced neat or else dissolved in appropriate aromatic solvents, aliphatic alcohols, or esters. Catalysts include Raney nickel and supported noble metals. Reduction is conducted between room temperature and 150 °C under hydrogen pressures in the range 350 –3500 kPa.
