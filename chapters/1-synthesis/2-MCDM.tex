...
\resizebox{\textwidth}{!}{
\begin{tabular}{l|S[table-format=4.2]S[table-format=1.1]XS[table-format=7.0,round-mode=figures,round-precision=2]|ll|lll|S[table-format=1]S[table-format=1]c}
\toprule
