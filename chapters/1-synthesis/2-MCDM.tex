...
The decision-making process using MCDM methods follows six steps: (1) identify the options to be appraised, (2) identify criteria to asses the consequences of each option, (3) scoring the expected performance of each option against a criteria, (4) assign criteria weightings, (5) compute, analyse and compare the weighted scores of each options, and (6) perform sensitivity analysis to evaluate the robustness of the final decision. 
