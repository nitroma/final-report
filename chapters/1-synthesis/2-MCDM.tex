...
Process development and especially synthesis route selection are regarded as the most critical conceptual design step since those major decisions affect the whole process lifecycle. To help decisionmake systematic and informed decisions for key aspects of the project, multi-criteria decision making (MCDM) methods were employed.

%Literature research into different reaction routes was conducted, and evaluation of the routes was done to determine the most suitable option. The selected reaction route was subsequently developed into a flowsheet including secondary manufacturing and waste treatment. The complexity of this decision making requires a consideration of diverse factors, including environmental, economics, and process control (Zavadskas et al., 2016). In addition to choosing the reaction route, other major decisions had to be made to improve the production efficiency and safety aspects of the plant. To minimise subjectivity and bias when performing a comparative evaluation between options, multiple-criteria decision making (MCDM) analysis was employed to evaluate each alternative in a quantitative manner. Motivation to do MCDM

%Decision making is often challenging due to the need to consider various, and conflicting, criteria. Particularly in the design of chemical processes, it is difficult to locate one optimal solution that is sustainable in multiple aspects based on a single criterion. Multi-criteria decision making (MCDM) is then introduced as a tool to aid the selection of an optimal solution when a collective group of good but non-dominating alternatives are available. This helps stakeholders to make more explicit decisions and meet design objectives through the means of providing quantitative analysis and evaluation of the project’s performance in realistic scenarios36. Through detailed discussion and comparison of different synthesis routes, this Section makes use of MDCM tools on the synthesis route to produce diazomethane, balancing process safety, environmental impact and the overall plant efficiency.
