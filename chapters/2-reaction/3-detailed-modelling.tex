...
As seen in \cref{fig:Adiabatic-without-cooling}, the reactor is impossible to operate

Even with an external cooling jacket to cool down the reactor, . Additionally, the possibility of hotspot as shown in Fig [hotspot] will speed up the deactivation of catalyst, but more importantly, it will pose significant safety concerns through the risk of thermal runaway [nguyen balakotiah]. Therefore, to maintain the safety of the plant, the temperature of the reactor needs to be well-controlled.
