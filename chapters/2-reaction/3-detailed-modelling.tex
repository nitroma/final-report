...
\end{wrapfigure}
\textcite{young_axial_1973} showed that if temperature and concentration distribution (i.e conversion) are important, then axial dispersion must be taken into account. 
