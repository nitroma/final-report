...
The reactor choices were considered based on several selection criteria, namely, 1) Attrition of catalyst; 2) Hot spot formation; 3) Pressure drop; 4) Heat transfer; 5) Mass transfer; 6) 
\begin{enumerate}
