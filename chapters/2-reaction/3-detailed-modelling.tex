...
The nitration reactor cannot be assumed to be isothermal because nitration is a highly exothermic process. As seen in Fig. [], the temperature rises sharply in the first xxx meters before plateauing at xxx K. Even by cooling the reactor with a cooling jacket, the exit temperature remains at xxx.
Temperature of the reaction needs to kept below 140 \degrees \celsius. At temperatures higher than that, thermal decomposition of nitric acid occurs, which releases nitrogen dioxide and produces even more heat, leading to thermal runaway. Therefore, to maintain the safety of the plant, the coo
\textcolor{red}{Include adiabatic temp rise with cooling water}
