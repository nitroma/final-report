...
\end{wrapfigure}
\textcite{young_axial_1973} showed that if temperature and concentration distribution (i.e conversion) are important, then axial dispersion must be taken into account. Axial dispersion is a function of the diameter of reactor and is independent of the total length. The diameter needs to be adjusted to ensure axial effects
