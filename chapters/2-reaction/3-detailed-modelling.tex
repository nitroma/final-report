...
The intraparticle void fraction for H-mordnite is typically 0.463 (saleman et al)
...
At the [specify radius of particle], the Weisz-Prater  it can be considered that there are no diffusional limitations in the catalyst, and no concentration gradient. T
The tortuosity of the pellet
...
From the graph, a diameter of 20cm has been selected as the optimal diameter based on graph X as minimal axial dispersion is preferred. Moreover, any further increase in the diameter does not warrant the drawback of the increasing pressure drop ($\delta P$).
