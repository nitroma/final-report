...
Triple concentric tubes increases the heat transfer rate through the increased heat exchange area between the fluid and both the inner and outer side of the annulus [ref]. An enhanced heat exchange network within the reactor maintains the temperature in the desirable range of < 90°C. 
