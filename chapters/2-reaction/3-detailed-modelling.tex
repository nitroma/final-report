...
The relationship between axial dispersion coefficient ($D_z$) and diameter was investigated in \cref{fig:dispersion}. It can be observed that the dispersion coefficient decreases exponentially from \SI{1e-1}{\m}. The dispersion coefficient decreases by \SI{75}{\%} from \SI{1e-1}{\m} to \SI{2e-1}{\m}. Although having a larger diameter would decrease. \SI{1.78}{\metre \square}
A final diameter of \SI{23}{\cm} has been selected as any further increase in the diameter does not warrant the drawback of the 
