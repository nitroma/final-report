...
Two options that were considered were: 1) Using Silicon Carbide as H-mordenite support; 2) Using Silicon Carbide as H-mordenite support, plus an additional concentric cooling flow through each channel. 

Silicon Carbide was chosen as the catalyst support owing to its high thermal conductivity (100-200 W m \textsuperscript{-1} K \textsuperscript{-1} as compared to 3 W m \textsuperscript{-1} K \textsuperscript{-1} for H-mordenite). This helps to keep the catalyst bed at a uniform temperature by reducing the temperature of catalyst surface temperature [ref]
