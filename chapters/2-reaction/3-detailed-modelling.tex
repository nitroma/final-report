...
Besides, an important feature of the SiC catalyst support is that it behaves like a static mixer that promotes homogeneous mixing of the reactants [ref]. For a two-phase reaction such as nitration, the well-mixed flow will increase the interphase contact area, and subsequently increase the rate of reaction. Thus, the reaction can be modelled as a single phase reaction on COMSOL. [can be moved to other sections] Additionally, the mechanical strength of the support reduces attrition of the catalyst when
