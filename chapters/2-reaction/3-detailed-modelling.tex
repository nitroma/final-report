...
- add a table summary of our design - refer to reactor choices (pressure drop tab) \textcolor{red}{here or appendix?}
\textcolor{red}{also check: why is the table so damn big}
...
\multicolumn{1}{|l|}{Overall volumetric flowrate}  & \multicolumn{1}{l|}{1.32 x 10^-4} & \multicolumn{1}{l|}{m^3/s} & \multicolumn{1}{l|}{} \\ \midrule
\multicolumn{1}{|l|}{Number of tubes}              & \multicolumn{1}{l|}{19}           & \multicolumn{1}{l|}{-}     & \multicolumn{1}{l|}{} \\ \midrule
\multicolumn{1}{|l|}{Diameter of each channel}     & \multicolumn{1}{l|}{0.2}          & \multicolumn{1}{l|}{m}     & \multicolumn{1}{l|}{} \\ \midrule
\multicolumn{1}{|l|}{Area of each channel}         & \multicolumn{1}{l|}{3.14 x 10^-2} & \multicolumn{1}{l|}{m^2}   & \multicolumn{1}{l|}{} \\ \midrule
\multicolumn{1}{|l|}{Length of reactor}            & \multicolumn{1}{l|}{3.97}         & \multicolumn{1}{l|}{m}     & \multicolumn{1}{l|}{} \\ \midrule
\multicolumn{1}{|l|}{Aspect ratio}                 & \multicolumn{1}{l|}{19.8}         & \multicolumn{1}{l|}{-}     & \multicolumn{1}{l|}{} \\ \midrule
\multicolumn{1}{|l|}{Bed voidage}                  & \multicolumn{1}{l|}{0.39}         & \multicolumn{1}{l|}{-}     & \multicolumn{1}{l|}{} \\ \midrule
\multicolumn{1}{|l|}{Particle diameter}            & \multicolumn{1}{l|}{2 x 10^{-4}    & \multicolumn{1}{l|}{m}     & \multicolumn{1}{l|}{} \\ \midrule
\multicolumn{1}{|l|}{Mass of H-mordenite required} & \multicolumn{1}{l|}{277}          & \multicolumn{1}{l|}{kg}    & \multicolumn{1}{l|}{} \\ \midrule
\multicolumn{1}{|l|}{Mass of inert SiC}            & \multicolumn{1}{l|}{4215}         & \multicolumn{1}{l|}{kg}    & \multicolumn{1}{l|}{} \\ \midrule
\multicolumn{1}{|l|}{Volume of liquid in reactor}  & \multicolumn{1}{l|}{9.24 x 10^-1} & \multicolumn{1}{l|}{m^3}   & \multicolumn{1}{l|}{} \\ \midrule
\multicolumn{1}{|l|}{Total reactor volume}         & \multicolumn{1}{l|}{2.37}         & \multicolumn{1}{l|}{m^3}   & \multicolumn{1}{l|}{} \\ \midrule
