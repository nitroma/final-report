...
Two options that were considered were: 1) Mixing the H-mordenite with Silicon Carbide; 2) Mixing the H-mordenite with Silicon Carbide, plus an additional concentric cooling flow through each channel. 
