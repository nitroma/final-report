...
From plot Y, it can be observed that a final number of tubes ($n_t$) of 7 will provide a required length ($L$) of 4.2m, and allowing an acceptable pressure drop ($\Delta P$)of 0.1bar.  