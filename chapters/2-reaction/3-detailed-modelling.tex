...
Besides, an important feature of the sintered SiC catalyst support is that the tortuosity of the structure promotes homogeneous mixing of the reactants, much like a static mixer \cite{duong-vi_silicon_2016}. As the nitration of toluene is a multiphase reaction, the SiC catalyst ensures well-mixed flow, which increases the interphase contact area between the aqueous and organic phase, and subsequently increases the rate of reaction. Having the SiC catalyst support allows the reaction to be modelled as a single phase reaction.
