...
\begin{equation}
    ...
    \label{eqn:ergun}
\end{equation}
where bed voidage of the packed bed ($\varepsilon$) is 0.30 from (), $d_p$ is the particle diameter equivalent to the SiC foam structure based only on its mean windows size (a) and the foam porosity using the following formula:

\begin{equation}
d_{s}=\frac{3a[(4 / 3 \pi)(1-\varepsilon)]^{1 / 2}}{2(1-[(4 / 3 \pi)(1-\varepsilon)]^{1 / 2})}
\end{equation}
