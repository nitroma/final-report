...
The maximum temperature ($T_{max}$) was calculated to be 387K, which denotes a temperature change ($\Delta T$) of 57K. This temperature was deemed to be risky as it is within a touching distance of 
