...
The maximum temperature ($T_{max}$) was calculated to be 387K, which denotes a temperature change ($\Delta T$) of 57K. This temperature was deemed to be risky as it is within a close (refer safety) distance to a thermal runaway , based on Section \textcolor{red}{Safety section}. A novel idea of including an additional concentric cooling tube running in the middle of the channel was considered in section (). 
