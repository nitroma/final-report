...
\end{wrapfigure}
\textcite{young_axial_1973} showed that if temperature and concentration distribution (i.e conversion) are important, then axial dispersion must be taken into account to ensure accurate modelling of flow. Axial dispersion is a function of the diameter of reactor and is independent of the total length. Thus, an optimal diameter needs to be selected to minimise axial dispersion.
