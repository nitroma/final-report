...
As mentioned in \cref{sec:adiabatic}, it is insufficient to only have an external cooling jacket. Triple concentric tubes heat exchanger (TCTHE) was considered to allow for better temperature control in the reactor. 
