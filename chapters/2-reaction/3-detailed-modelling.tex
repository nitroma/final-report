...
The maximum temperature of the channel was determined to be in the middle of the tube , which was calculated using equation \ref{eqn:radialheattransfer}, 
\begin{equation}
    T_{max} = T_s + \frac{S}{4k}R^2
    \label{eqn:radialheattransfer}
\end{equation}
where the $T_s$ represents the temperature at the wall at 330K, $k$ represents teh
