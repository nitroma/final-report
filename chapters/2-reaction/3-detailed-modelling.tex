...
\end{equation}
where the intraparticle void fraction for H-mordenite is 0.463 from (saleman et al), the pore diffusion is 4.42  \times 10\textsuperscript{-10} and the tortuosity of the pellet was found to be 1.63 using the equation given in [ref]
