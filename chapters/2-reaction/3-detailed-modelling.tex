...
Additionally, the mechanical strength of the support reduces attrition of the catalyst when. The strength of the SiC catalyst support does not decrease over time because SiC forms a silica film in a HNO3 solution, therefore rendering it passive against corrosion [ref].
