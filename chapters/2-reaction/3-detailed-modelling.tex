...
As seen in \cref{fig:Adiabatic-without-cooling}, the temperature rises sharply when the reactants are first mixed at the start of the reactor is first mix before plateauing at xxx K for an adiabatic reactor. Even with an external cooling jacket to cool down the reactor, there exists a hot. Additionally, the possibility of hotspot as shown in Fig [hotspot] will speed up the deactivation of catalyst, but more importantly, it poses safety concerns through the risk of thermal runaway [ref]. Therefore, to maintain the safety of the plant, the temperature of the reactor needs to be well-controlled.
