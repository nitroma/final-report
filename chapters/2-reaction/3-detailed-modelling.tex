...
At the [specify radius of particle], the Weisz-Prater  it can be considered that there are no diffusional limitations in the catalyst, and no concentration gradient
