...
The catalyst employed in the packed bed is cobalt phthalocyanine, with an overall loading of \SI{5}{\g\per\L}. The feeds to the reactor are a \SI{70}{\percent\of{w/v}}
