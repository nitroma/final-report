...
The physics interfaces used to model each zone of the reactor, as well as assumptions made in modelling, are outlined below. Key parameters of the reactor design are presented in \cref{reactoro} Further details of the equations implemented are available in \cref{app:comsol}.
