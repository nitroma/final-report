...
Due to the high flow rate through the tube (\SI{0.3}{\kg\per\s}) and its small diameter, the flow regime is turbulent. Temperature-dependent fluid density and viscosity are determined from the COMSOL material library.
