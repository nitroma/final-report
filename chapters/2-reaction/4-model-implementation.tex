...
The reactor sees a sharp rise in conversion (\approx 80\%) in the first 1m of reactor before achieving the remaining 20\% in the next \approx 3m. This can be explained by the rate of reaction as shown in Figure \ref{fig:comsol-performance:r_TOL}. The reaction proceeds at the highest rate in the first 0.5m 

temperature variation as shown in Figure \ref{fig:comsol-temperature}. The reaction proceeds most rapidly when high concentrations of reactants are first mixed together at the start of the reactor. 
