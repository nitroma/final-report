...
\begin{figure}[h]
    ...
    \label{fig:comsol-S2}
\end{figure}
Coolant flowrate and diameter of inner cooling tube were optimised to keep temperature below the safe limit of 363K while maintaining a  at above 98\% conversion.
