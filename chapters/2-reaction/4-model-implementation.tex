...
An interesting occurrence can be pointed out in \cref{fig:comsol-temperature:radial}. The figure shows the radial temperature profile at the slice of the reactor with the highest temperature.

Without eicooling water on

The asymmetrical parabola is due the different heat flux across the inner and outer sides of the reaction annulus.
