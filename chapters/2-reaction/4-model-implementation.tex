...
\ch{HNO3}:Toluene inlet flowrate ratio was optimised to achieve 98\% conversion in the shortest reactor length possible. Nitric acid is always kept in excess to maximise the formation of nitronium ion on the catalyst surface. A higher concentration of nitronium ion can then react with. Conversely, if the toluene is in excess, it will block the acid sit as much tol. The results showed that varying the ratio . The ratio 
