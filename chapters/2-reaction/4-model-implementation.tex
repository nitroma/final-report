...
Temperature-dependent thermal conductivity of the fluid is found from the COMSOL material library. The inflow boundary condition is set to the mixed coolant stream temperature of \SI{325}{\K} (see \ccref
