...
As seen in Figure \ref{fig:comsol-S2:maxT}, it is desirable to have a small inner cooling tube diameter and a high coolant flowrate to keep the reactor temperature low. below the limit of 363K. Conversion is not an issue here as all the parameters in the analysis is done at a conversion above 98 \%.
