...
COMSOL was selected for detailed reactor modelling, utilising the CFD and Heat Transfer modules \cite{comsol_comsol_2020,comsol_cfd_2020,comsol_heat_2020}. A single tube of the reactor was modelled in 2D axisymmetric geometry (i.e. in cylindrical coordinates). The physics interfaces used to model each zone of the reactor, as well as assumptions made in modelling, are outlined below.

\subsubsection{Reaction zone}

\paragraph{Mass transfer: Brinkman equations}
The Brinkman equations describe flow through porous media
