...
In the porous medium, heat transfer is described by a volume-averaged combination of the solid and fluid equations, respectively \cite{comsol_}
...
- conservative approach, sourced from
\begin{wrapfigure}{r}{0pt}
    \vspace{-\intextsep}
