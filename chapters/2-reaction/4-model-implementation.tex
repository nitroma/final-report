...
\begin{equation}
    \frac{\partial}{\partial t}\left(\varepsilon_{\mathrm{p}} \rho\right)+\nabla \cdot(\rho \mathbf{u})=Q_{\mathrm{m}}
\end{equation}

\begin{equation}
\frac{\rho}{\varepsilon_{\mathrm{p}}}\left(\frac{\partial \mathbf{u}}{\partial t}+(\mathbf{u} \cdot \nabla) \frac{\mathbf{u}}{\varepsilon_{\mathrm{p}}}\right)=
...
\paragraph{Heat transfer in porous media}
