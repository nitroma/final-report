...
A sensitivity analysis was performed on the number of reactor channels, shown in \cref{fig:S5-T-X}. An intersting point to note is that increasing number of tubes increases the average temperature as the peak temperature is more broad and spread out across the temperature. Although this would suggest
