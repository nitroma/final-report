...
The secondary cooling tube was simulated in both co-current and counter-current flow modes relative to the reaction zone ({\label{fig:comsol-temperature:lines:countercurrent}
