...
\begin{figure}[h]
    ...
    \begin{subfigure}{0.49\linewidth}
        \includegraphics[width=\linewidth, scale= 0.7]{figures/S2-maxT.png}
        \caption{Maximum temperature reached in the reactor}
        \label{fig:comsol-S2:maxT}
    \end{subfigure}
    \begin{subfigure}{0.49\linewidth}
        \includegraphics[width=\linewidth, scale= 0.7]{figures/S2-CW-Pdrop.eps}
