...
Moreover, having a larger inner diameter gives the flexibility of increasing inner coolant flowrate when the reactant flowrate increases in the future as a result of higher expected throughput demand. The final values were  
- in case need more
...
Countercurrent: CW removes heat from downstream section (slowing 
