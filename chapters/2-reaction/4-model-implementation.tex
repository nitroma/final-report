...
A sensitivity analysis was performed on the number of reactor channels, shown in \cref{fig:S5-T-X}. As the number of tubes increases, the volumetric flowrate per tube decreases thus providing a higher residence time leading to an overall increase in conversion. 
