...
A sensitivity analysis was performed on the number of reactor tubes required in Figure \ref{fig:S5-T-X}. An optimal number of 7 was chosen as it provides the best the lowest maximum temperature at 
See \cref{fig:S5-T-X}.
