...
The results showed that the conversion of toluene for 2 and 3 \ch{HNO3}:Toluene molar ratio were very similar, which suggest that the surface of the catalyst had already been fully saturated. Therefore, increasing molar flowrate of nitric acid would not enhance the conversion of the nitration reaction, but would instead lead to higher OPEX costs of supplying nitric acid to the reactor. It could also complicate the separation process of the 3 nitrotoluene isomers downstream. 

As safety is one of the key priorities of Nitroma in all decision making, the maximum temperature in the reactor were analysed for both cases. It was found that both were below the safe limit of 363K, hence, a molar flowrate ratio of 2 was selected.
