...
Moreover, having a larger inner diameter gives the flexibility of increasing inner coolant flowrate when the reactant flowrate increases in the future as a result of higher expected throughput demand. 
...
\begin{figure}[h]
    ...
    \caption{Effect of CW temp on distance required to reach 98\% conversion (blue) and max T (green)}
