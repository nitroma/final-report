...
According to the modified Ergun equation, shown in equation \ref{eqn:ergun} the pressure drop ($\delta p$) is inversely proportional to the length of the reactor, a shorter reactor is more favourable.  Moreover, the targeted conversion of 98\% can be achieved well within 4m of reactor length.
