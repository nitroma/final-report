...
Nitric acid interacts with the Brønsted acid sites on H-Mordenite by forming a hydrogen bond with the \ch{H+} proton. This results in a intermediate nitronium ion \ch{NO2+} and water molecule \. The nitronium ions then undergo electrophilic substitution with toluene to form nitrotoluenes. The electron-donating inductive effect of the methyl group on toluene favors \ortho and \para positions for nitrotoluene.
