...
\begin{equation}
-\frac{d C_{Toluene}}{d t}=k_{2} C_{Toluene} C_{Nitric Acid}
\end{equation}

The nitration of toluene is dominated by intrinsic kinetics under the experimental conditionThe rate equation can be defined as a first-order rate express
