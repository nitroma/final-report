...
where $k_2$, $k_1$ are the second-order and pseudo-first order rate constant respectively. A pseudo-first order rate constant can be assumed since nitric acid is in excess. The zeolite catalysed nitration reaction follows the kinetics found in [jeeru et al]. The rate constant varies with temperature according to the Arrhenius equation. The summary table of the activation energy and pre-exponential factor for the formation of all 3 isomers of nitrotoluene can be found in Appendix [ref].
