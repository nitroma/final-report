...
\begin{figure}[H]
    ...
    \caption{3D cross section of concentric secondary cooling water system with dimensions in units of mm}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\linewidth, scale=0.5]{chapters/2-reaction/figures/FYD reactor poster boy both.PNG}
