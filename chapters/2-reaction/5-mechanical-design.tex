...
Gasket is a sealing material placed between flanges to create a leak-proof sealing \cite{varun_piping_nodate}. A narrow-faced, ring joint gasket type was chosen due to the suitability of design and excellent sealability in small sealing area \cite(). The octagonal soft steel gasket was chosen to complement choice of ring joint gasket as it is softer than the flange material. The chosen gasket has a gasket factor (m) of 5.5 and minimum design seating stress (y) of \SI{124}{\N\per\mm}. (BS5500)
