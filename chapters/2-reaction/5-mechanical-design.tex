...
\cref{sec:adiabatic} requires the reactor to operate below \SI{363}{\K} and a pressure gradient of \SIrange{1}{1.3}{\bar}. The design temperature is set as \SI{363}{\K} following the maximum operaand design pressure ($p_d$) is calculated to be \SI{1.44}{\bar}, using \cref{eqn:designpressure} below:
\begin{equation}
