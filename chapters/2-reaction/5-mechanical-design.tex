...
According to section X, the reactor must operate within the temperature range of 330K to 378K and pressure gradient of 1 bar to 1.3 bar. The design temperature is set as XXK and design pressure ($p_d$) is calculated to be YYY bar, using the equation \ref{eqn:designpressure} below:
\begin{equation}
    p_d = \frac{P_o}{0.9} = \frac{1.3}{0.9}  bar
