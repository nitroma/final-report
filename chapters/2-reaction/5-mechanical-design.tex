...
\end{wrapfigure}
The bundle of 7 tubes was arranged in such a manner with a clearance of 230mm, which exceeds t between each tubes to maximise cooling heat transfer. 2 tube sheets were fitted at each ends of the shell to fix the tubes in position. A triangular tube arrangement was selected due to the more robust tube sheet construction (). The clearance of the tube arrangement was set to be 230mm, equivalent to the tube diameter. This exceeds the rule of thumb for minimum clearance of 0.25 times of tube diameter based on Primo et al.  The arrangement of 7 tubes held by the tube sheet is shown in \cref{fig:reactortubearrangement}.
