...
Similarly, minimum thickness of the shell ($e_{shell}$) was calculated using equation \ref{eqn:minthicknessreactor}, with $D_i$ set as 1.5m, $d_p$ as 1.1bar and $f$ value of 143$Nmm_{-2}$. The minimum thickness of the tube was calculated to be 0.5mm, 
