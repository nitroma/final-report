...
\subsubsection{Reactor dimensions}
\begin{equation}
    e_{cylinder} = \frac{p_dD_i}{2f-p_d} = \frac{0.11 \times 1500}{2 \times 143}
    \label{eqn:minthicknessreactor}
\end{equation}

Similarly, minimum thickness of the shell ($e_{shell}$) was calculated using equation \ref{eqn:minthicknessreactor}, with $D_i$ set as 1.5m, $d_p$ as 1.1bar and $f$ value of 143$Nmm_{-2}$. The minimum thickness of the shell was calculated to be 0.5mm. After taking into account corrosion allowance of 1.5mm and other welding considerations, a final shell thickness of 5mm was chosen. 
