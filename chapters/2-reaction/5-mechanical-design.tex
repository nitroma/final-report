...
The overall cross section design of the reactor can be seen in Figure \ref{fig:mainreactor} below. Additional mechanical design drawings from SolidWorks are included in Appendix .
\begin{figure}[H]
    \centering
