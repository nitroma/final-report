...
The strong oxidising property of nitric acid as a result of autocatalytic reduction gives nitric acid very corrosive property at \SI{70}{\percent\wv} \cite{suresh_corrosion_nodate}. The reactor material needs to be carefully selected to ensure the reactants do not corrode the walls, which gives rise to more possible location for hotspot.
