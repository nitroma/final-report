...
PRV was included as a safety device to protect the vessel and relief pressure in case of a overpressure event ().An overpressure event will occur when the pressure is beyond the design pressure (also known as maximum allowable working pressure) (). The sizing of safety relief valves was calculated based on the equation given in API 520 () in the equation below,
\begin{equation}
