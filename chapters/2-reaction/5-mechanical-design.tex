...
As mentioned in Section (coolingwater), the secondary cooling water system was implemented in a concentric manner within the reactor tubes to prevent thermal runaway in hotspots. Each secondary cooling water tubes have a flowrate of 1.5\
