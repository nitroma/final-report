...
The inlet and outlet of the reactant flow were placed at the top right and top left of the shell dome respectively. Both ports were estimated to have a acceptable feed liquid velocity range (U) of 0.1 - 1 $ms^{-1}$. The cross section area (A) is calculated by dividing the volumetric flowrate ($Q_v$) shown in the equation \ref{eqn:area} below. Then, the outer pipe diameter (OD) was calculated using the equation \ref{eqn:portOD} below. 
\begin{equation}
    A = \frac{Q_v}{U}
    \label{eqn:area}
\end{equation}
\begin{equation}
    ...
    \label{eqn:portOD}
\end{equation}
The diameter of the reactant inlet and outlet ports were defined with OD of 114.3mm (4" NPS) with 6mm of wall thickness. The diameter of the primary cooling water port was defined to have an OD of 219.1mm (8" NPS) with 6.55mm of wall thickness. The diameter of the secondary cooling tube were defined as OD of 60mm (2" NPS) with 4mm of wall thickness. All port dimensions were calculated based on information from BS 1600:1991. 
