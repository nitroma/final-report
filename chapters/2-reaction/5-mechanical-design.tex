...
The inlet and outlet of the reactant flow were placed at the top right and top left of the shell dome respectively. Both ports were estimated to have a acceptable feed liquid velocity range (U)of 0.1 - 1 $ms^{-1}$. The cross section area (A) is calculated using the equation ref below. Then, the outer pipe diameter (OD) was calculated using the equation \ref{eqn} below. 
\begin{equation}
    \label{eqn:area}
    A = \frac{Q_v}{U}
\end{equation}
